    ...
    return (
        <section id="aboutLanding" className="lg-container">
            ...
            <div className="content-column">
                ...
                <p>
                Hi! I am a fourth year student currently completing a software engineering and business dual degree through Western University and Ivey. I am a front end developer, machine learning enthusiast, and aspriring full stack developer who enjoys tackling difficult problems, learning new ideas, and discovering technologies. 
                </p>
                <p>
